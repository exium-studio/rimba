const translations = {
  ...
  "february": "Februari",
  "feedback_label_1": "Sangat buruk",
  "feedback_label_2": "Buruk",
  "feedback_label_3": "Cukup",
  ...
  "lp_navs": {
    ...
    "map": {
      ...
      "green_economy": "Kepatuhan Ekonomi Hijau",
      "impact_analysis": "Dampak Aktual Proyek",
  ...
  "msg_ask_our_help_desk": "Ada yang bikin bingung? Tim help desk kami siap bantu kamu kapan aja!",
  ...
  "msg_select_material_first": "Pilih materi yang anda mau baca di kolom sebelah ${position}",
