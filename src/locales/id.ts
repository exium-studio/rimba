const translations = {
  ...
  error_409_quiz_attempt_closed: {
    ...
    description:
      "Kamu tidak bisa lagi mengirim jawaban karena waktu pengerjaan kuis telah berakhir.",
  },
  error_413_default: {
  ...
  feedback_question:
    "Bagaimana pendapatmu tentang course <b>${courseName}</b>?",
  finished: "Selesai",
  friday: "Jumat",
  get: "Dapatkan",
  grade: "Nilai",
  ...
  info_material_time_not_elapsed: {
    ...
    description:
      "Kamu perlu menyelesaikan waktu belajar minimal ${minTime} sebelum lanjut ke materi berikutnya, tersisa ${remainingTime} hingga ${endTime}.",
  },
  info_quiz_not_ready: {
  ...
  msg_ask_our_help_desk:
    "Ada yang bikin bingung? Tim help desk kami siap bantu kamu kapan aja!",
  ...
  msg_input_feedback_to_get_course_certificate:
    "Masukkan feedback Anda untuk mendapatkan sertifikat kursus ini.",
