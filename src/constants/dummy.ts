...
export const lp_contents = {
  ...
  5: { contentType: "image", content: `${IMAGES_PATH}/default_gallery/1.jpg` },
  6: { contentType: "image", content: `${IMAGES_PATH}/default_gallery/2.jpg` },
  7: { contentType: "image", content: `${IMAGES_PATH}/default_gallery/3.jpg` },
  8: { contentType: "image", content: `${IMAGES_PATH}/default_gallery/4.jpg` },
  9: { contentType: "image", content: `${IMAGES_PATH}/default_gallery/5.jpg` },
  10: { contentType: "image", content: `${IMAGES_PATH}/default_gallery/6.jpg` },
  11: { contentType: "image", content: `${IMAGES_PATH}/default_gallery/7.jpg` },
  12: { contentType: "image", content: `${IMAGES_PATH}/default_gallery/8.jpg` },
  13: { contentType: "image", content: `${IMAGES_PATH}/default_gallery/9.jpg` },
  14: {
    contentType: "image",
