const translations = {
  ...
  error_409_quiz_attempt_closed: {
    title: "Quiz closed",
    description:
      "You can no longer submit answers because the quiz session has ended.",
  },
  error_413_default: {
  ...
  info_material_time_not_elapsed: {
    ...
    description:
      "You need to complete the minimum ${minTime} study time before proceeding to the next material, remaining ${remainingTime} until ${endTime}.",
  },
  info_quiz_not_ready: {
  ...
  msg_ask_our_help_desk:
    "Something confusing? Our help desk team is ready to help you anytime!",
  ...
  msg_input_feedback_to_get_course_certificate:
    "Enter your feedback to get this topic certificate.",
